...
/// <summary>
/// Seeds CSV and other data files from the publish folder into <see cref="RavaDataPaths"/> when missing.
/// Never overwrites files already present in the data directory.
/// </summary>
public static class RavaDataFileBootstrap
{
    /// <summary>
    ...
    {
        var dataPath = RavaDataPaths.ResolveFile(contentRootPath, fileName);
