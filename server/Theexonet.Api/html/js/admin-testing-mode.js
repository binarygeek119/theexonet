export const TESTING_MODE_STORAGE_KEY = "theexonet.admin.testingMode";
export const REMOVED_DUMMY_FRIENDS_KEY = "theexonet.admin.testingMode.removedFriends";
...
/**
 * @param {import("./api.js").TheexonetApi} api
...
function buildDummyPlayerSummary(index) {
  ...
  return {
    id,
    username,
    email: `${username}@test.theexonet.local`,
    credits,
