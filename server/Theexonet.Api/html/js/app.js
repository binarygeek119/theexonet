...
function openRegisterTosPanel() {
  ...
  try {
    ...
    console.error("[theexonet] failed to render Terms of Service", error);
  }
...
async function startApp() {
  ...
  document.addEventListener("theexonet:localechange", () => {
    applyTranslations(document);
...
startApp().catch((error) => {
  console.error("[theexonet] startup failed", error);
});
