...
/// Set environment variable THEEXONET_DATA_DIR on systemd services.
/// </summary>
public static class TheexonetDataPaths
{
    public const string EnvironmentVariable = "THEEXONET_DATA_DIR";
